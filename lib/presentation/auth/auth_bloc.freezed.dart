...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _CheckAuthStatus value)?  checkAuthStatus,TResult Function( _AuthStateChanged value)?  authStateChanged,TResult Function( _SignIn value)?  signIn,TResult Function( _Register value)?  register,TResult Function( _SignOut value)?  signOut,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CheckAuthStatus() when checkAuthStatus != null:
return checkAuthStatus(_that);case _AuthStateChanged() when authStateChanged != null:
return authStateChanged(_that);case _SignIn() when signIn != null:
return signIn(_that);case _Register() when register != null:
return register(_that);case _SignOut() when signOut != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _CheckAuthStatus value)  checkAuthStatus,required TResult Function( _AuthStateChanged value)  authStateChanged,required TResult Function( _SignIn value)  signIn,required TResult Function( _Register value)  register,required TResult Function( _SignOut value)  signOut,}){
final _that = this;
switch (_that) {
case _CheckAuthStatus():
return checkAuthStatus(_that);case _AuthStateChanged():
return authStateChanged(_that);case _SignIn():
return signIn(_that);case _Register():
return register(_that);case _SignOut():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _CheckAuthStatus value)?  checkAuthStatus,TResult? Function( _AuthStateChanged value)?  authStateChanged,TResult? Function( _SignIn value)?  signIn,TResult? Function( _Register value)?  register,TResult? Function( _SignOut value)?  signOut,}){
final _that = this;
switch (_that) {
case _CheckAuthStatus() when checkAuthStatus != null:
return checkAuthStatus(_that);case _AuthStateChanged() when authStateChanged != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  checkAuthStatus,TResult Function( AppUser? user)?  authStateChanged,TResult Function( String email,  String password)?  signIn,TResult Function( String email,  String password,  String? displayName)?  register,TResult Function()?  signOut,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CheckAuthStatus() when checkAuthStatus != null:
return checkAuthStatus();case _AuthStateChanged() when authStateChanged != null:
return authStateChanged(_that.user);case _SignIn() when signIn != null:
return signIn(_that.email,_that.password);case _Register() when register != null:
return register(_that.email,_that.password,_that.displayName);case _SignOut() when signOut != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  checkAuthStatus,required TResult Function( AppUser? user)  authStateChanged,required TResult Function( String email,  String password)  signIn,required TResult Function( String email,  String password,  String? displayName)  register,required TResult Function()  signOut,}) {final _that = this;
switch (_that) {
case _CheckAuthStatus():
return checkAuthStatus();case _AuthStateChanged():
return authStateChanged(_that.user);case _SignIn():
return signIn(_that.email,_that.password);case _Register():
return register(_that.email,_that.password,_that.displayName);case _SignOut():
return signOut();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  checkAuthStatus,TResult? Function( AppUser? user)?  authStateChanged,TResult? Function( String email,  String password)?  signIn,TResult? Function( String email,  String password,  String? displayName)?  register,TResult? Function()?  signOut,}) {final _that = this;
switch (_that) {
case _CheckAuthStatus() when checkAuthStatus != null:
return checkAuthStatus();case _AuthStateChanged() when authStateChanged != null:
return authStateChanged(_that.user);case _SignIn() when signIn != null:
...
class _Register implements AuthEvent {
  const _Register({required this.email, required this.password, this.displayName});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Register&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.displayName, displayName) || other.displayName == displayName));
}
